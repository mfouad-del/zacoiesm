...
export const TRANSLATIONS = {
  en: {
    ...
    correspondenceLog: 'Correspondence Log',
    pending: 'Pending',
    replied: 'Replied',
    closed: 'Closed',
    ...
    ver: 'Ver',
    action: 'Action',
    selectModel: 'Select a model to view',
    loading: 'Loading',
    initializingWebGL: 'Initializing WebGL Context',
    objects: 'Objects',
    materials: 'Materials'
  },
  ar: {
    ...
    correspondenceLog: 'سجل المراسلات',
    pending: 'معلق',
    replied: 'تم الرد',
    closed: 'مغلق',
    ...
    ver: 'الإصدار',
    action: 'الإجراء',
    selectModel: 'اختر نموذج للعرض',
    loading: 'جار التحميل',
    initializingWebGL: 'جار تهيئة WebGL',
    objects: 'العناصر',
    materials: 'المواد'
  }
};
